...
const bancoQuestoes = [
    ...
    { id: 3, disciplina: "Português", enunciado: "Qual frase apresenta erro de pontuação?", alternativas: { A: "Leandro, você já terminou o simulado?", B: "Passos, 30 de abril de 2026.", C: "O servidor, comprou os materiais ontem.", D: "Eles chegaram, viram o problema e resolveram." }, gabarito: "C", explicacao: "Não se separa o sujeito ('O servidor') do verbo ('comprou') com vírgula." },
